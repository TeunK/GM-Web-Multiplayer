...
Currently there are roughly 4,500,000 users registered to the Unity forum\footnote{http://forum.unity3d.com/forums}, however only a small percentage of this is active in 2D development as this only hosts 5,600 topics\footnote{http://forum.unity3d.com/forums/2d.53/}. 
...
\begin{enumerate}
\item An MIT-licensed opensource socket.io JavaScript library provided by LearnBoost: socket.io.js (documentation \footnote{https://docs.omniref.com/js/npm/socket.io/0.8.4})
...
\caption{External function from JavaScript extension file located in GMWebNet.js, mapped to a GML function located in the client client application. The function takes 2 arguments, each of type String (id = 1), and returns a Double type (id = 2)}
...
The network was controlled using Dummynet, using a below-average UK household network bandwidth \footnote{http://www.ispreview.co.uk/index.php/2015/02/ofcom-average-uk-home-broadband-speeds-slowly-reach-23mbps.html}. This involves an upload speed of 5Mbit/s, and a download speed of 1Mbit/, although no packet loss was set in order to ensure consistency throughout the controlled network experiments.
