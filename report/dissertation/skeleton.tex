...
The main GameMaker community forum is hosted by YoYoGames\footnote{http://gmc.yoyogames.com/}, serving 280.000 registered users recorded in January 2016, with a combined total of 220.000 topics and 3.480.000 posts. There also exists a notable GameMaker forum in the Netherlands\footnote{http://www.game-maker.nl/forums/} which hosts an additional 557000 posts for 56000 topics for almost 18000 members.

%TODO Do something with these "footnotes"!
...
\begin{center}
  \begin{tabular}{ | r || c | c | c | c | c | c | }
    ...
    \multicolumn{5}{l}{* \textit{Advertised by developer.mozilla.org}\footnote{https://developer.mozilla.org/en-US/docs/Games/Tools/Engines\_and\_tools}} \\
    \multicolumn{5}{l}{** \textit{Advertised by gamepix.com}\footnote{http://www.gamepix.com/blog/the-big-list-of-2d-html5-games-engines/}} \\
  \end{tabular}
\end{center}

\subsection{Pixi.js, EaselJS, Quintus and Crafty.js}
Despite Pixi.js, EaselJS, Crafty.js and Quintus being tools for developing 2D browser games, they are merely JavaScript frameworks and libraries to assist developers in creating raw JavaScript games. If networking is expected to be part of a browser game, these tools will also require additional resources for implementing this feature.

Their community is relatively small and scattered across the web. The forums for these tools are hosted on third-party websites and make it therefore hard to measure their size and activity accurately.
