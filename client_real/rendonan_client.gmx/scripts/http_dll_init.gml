...
global.define_listeningsocket_start_listening = external_define(dllfile,'listeningsocket_start_listening',dll_cdecl,ty_real,3,ty_real,ty_real,ty_real);
