...
quest5reward = real(buffer_read_string(buffer)); 
quest6reward = real(buffer_read_string(buffer)); 
quest7reward = real(buffer_read_string(buffer)); 
quest8reward = real(buffer_read_string(buffer)); 
